...
@Component(value = "backendFService")
public class BackendFService implements Service {

    private static final String BACKEND_F = "serviceF";

    @Override
    @CircuitBreaker(name = BACKEND_F)
    @Bulkhead(name = BACKEND_F)
    @Retry(name = BACKEND_F)
...
//    @Bulkhead(name = BACKEND_F)
//    @Retry(name = BACKEND_F)
//    @RateLimiter(name = BACKEND_F)
//    public String success() {
//        return "Hello World from backend D";
//    }

    @Override
    @RateLimiter(name = BACKEND_F, fallbackMethod = "rateLimiterFallback")
    public String success() {
    ...
    @Override
    @TimeLimiter(name = BACKEND_F)
    @CircuitBreaker(name = BACKEND_F, fallbackMethod = "fluxFallback")
    ...
    @TimeLimiter(name = BACKEND_F)
    @Bulkhead(name = BACKEND_F)
    @CircuitBreaker(name = BACKEND_F, fallbackMethod = "monoFallback")
    ...
    @Override
    @CircuitBreaker(name = BACKEND_F, fallbackMethod = "fallback")
    public String failureWithFallback() {
        return failure();
    }

    @Override
    @Bulkhead(name = BACKEND_F, type = Type.THREADPOOL)
    @TimeLimiter(name = BACKEND_F)
    @CircuitBreaker(name = BACKEND_F)
    @Retry(name = BACKEND_F)
    ...
    @Bulkhead(name = BACKEND_F, type = Type.THREADPOOL)
    @TimeLimiter(name = BACKEND_F)
    @CircuitBreaker(name = BACKEND_F, fallbackMethod = "futureFallback")
