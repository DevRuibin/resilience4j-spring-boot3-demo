...
@Component(value = "backendDService")
public class BackendDService implements Service {

    private static final String BACKEND_D = "serviceD";

    @Override
    @CircuitBreaker(name = BACKEND_D)
    @Bulkhead(name = BACKEND_D)
    @Retry(name = BACKEND_D)
...
//    @Bulkhead(name = BACKEND_D)
//    @Retry(name = BACKEND_D)
//    @RateLimiter(name = BACKEND_D)
//    public String success() {
//        return "Hello World from backend D";
//    }

    @Override
    @RateLimiter(name = BACKEND_D, fallbackMethod = "rateLimiterFallback")
    public String success() {
    ...
    @Override
    @TimeLimiter(name = BACKEND_D)
    @CircuitBreaker(name = BACKEND_D, fallbackMethod = "fluxFallback")
    ...
    @TimeLimiter(name = BACKEND_D)
    @Bulkhead(name = BACKEND_D)
    @CircuitBreaker(name = BACKEND_D, fallbackMethod = "monoFallback")
    ...
    @Override
    @CircuitBreaker(name = BACKEND_D, fallbackMethod = "fallback")
    public String failureWithFallback() {
        return failure();
    }

    @Override
    @Bulkhead(name = BACKEND_D, type = Type.THREADPOOL)
    @TimeLimiter(name = BACKEND_D)
    @CircuitBreaker(name = BACKEND_D)
    @Retry(name = BACKEND_D)
    ...
    @Bulkhead(name = BACKEND_D, type = Type.THREADPOOL)
    @TimeLimiter(name = BACKEND_D)
    @CircuitBreaker(name = BACKEND_D, fallbackMethod = "futureFallback")
